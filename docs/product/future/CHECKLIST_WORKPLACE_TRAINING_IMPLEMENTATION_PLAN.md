...
- [ ] anomalies покрыты integration/E2E — частично: 9 из 17 аномалий уже имели или получили в этом PR покрытие (см. "Что сделано" в статусе выше); #4, #6, #7, #11, #13, #15, #16, #17 остаются честно задокументированными пробелами, не закрытыми в этом PR.
