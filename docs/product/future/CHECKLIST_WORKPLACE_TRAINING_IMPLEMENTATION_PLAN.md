...
на реальном backend+frontend (не только моках), покрывающих 14 из 15 обязательных сценариев: полный
