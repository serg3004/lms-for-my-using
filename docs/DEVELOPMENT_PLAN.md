...
> **Обновлено (2026-08-26):** таблица ниже была рассинхронизирована с заголовками
> отдельных PR (123/125/127/131 значились ⚠️/❌/🔲 в сводке, хотя в своих секциях
> уже были ✅) — статусы ниже сверены с актуальными заголовками PR выше. Доверять
> нужно отдельным секциям PR, эта таблица — только сводка.
...
> **Обновлено (2026-08-26):** таблица ниже была рассинхронизирована с заголовками
> отдельных PR (перечисляла 134/136/138–142/144–146/148 как "не начато", хотя все
> они давно ✅ в своих секциях) — статусы ниже сверены с актуальными заголовками
> PR выше. Доверять нужно отдельным секциям PR, эта таблица — только сводка.

```
Новые фичи и архитектура         PR 132–150  19 PR  ✅ ВСЕ СДЕЛАНЫ
```
