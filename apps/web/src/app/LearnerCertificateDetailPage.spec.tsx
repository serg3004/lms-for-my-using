...
vi.mock('../shared/session.js', () => ({ useSession: () => ({
  currentUser: { id: 'u1', organizationId: 'o1', email: 'learner@example.com', firstName: 'Learner', lastName: 'User', middleName: null, position: null, shift: null, phone: null, status: 'active', locale: 'ru', timezone: 'UTC', roles: ['learner'] },
